...
call s:hl("DiffAdd", s:truegreen, s:white, "reverse")
call s:hl("DiffDelete", s:truered, s:white, "reverse")
call s:hl("DiffChange", s:cyan, s:white, "reverse")
...
call s:hl("MatchParen", s:cyan, s:bg, "reverse")
